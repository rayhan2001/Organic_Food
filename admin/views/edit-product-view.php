<?php 
    ...
    $ctg_info = $obj_adminBack->display_catagory();
 ...
 <?php if (isset($update_msg)) {
  ...
  <form class="form" action="" method="post" enctype="multipart/form-data">
  	<div class="form-group">
        <input hidden type="text" name="u_pdt_id" class="form-control" value="<?php echo $pdtinfo['pdt_it']; ?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="u_pdt_des" class="form-control" value="<?php echo $pdtinfo['pdt_des']; ?>">
    </div>
    <div class="form-group">
    ...
    <input type="submit" name="u_pdt_btn" value="Update Product" class="btn-block btn btn-primary">
</form>