                                            ...
                                            <li class="product-item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="contain-product layout-default">
                                                    <div class="product-thumb">
                                                        <a href="single_product.php?status=sigleproduct&&id=<?php echo $pro['pdt_id']; ?>"
                                                            class="link-to-product">
                                                            <img src="admin/upload/<?php echo $pro['pdt_img']; ?>"
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <h4 class="product-title"><a
                                                                href="single_product.php?status=sigleproduct&&id=<?php echo $pro['pdt_id']; ?>"
                                                                class="pr-name"><?php echo $pro['pdt_name']; ?></a></h4>
                                                        <div class="price">
                                                        ...
                                                        <div class="slide-down-box">
                                                            ...
                                                            <div class="buttons">
                                                                ...
                                                                <a href="single_product.php?status=sigleproduct&&id=<?php echo $pro['pdt_id']; ?>"
                                                                    class="btn compare-btn"><i class="fa fa-eye"
