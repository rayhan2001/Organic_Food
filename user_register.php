                ...
                <div class="row">
                        ...
                        <div class="signin-container">
                            <form action="#" name="frm-register" method="post">
                                ...
                                <p class="form-row">
                                    ...
                                    <input type="number" id="fid-name" name="user_mobile" value="" class="txt-input">
                                </p>
                                <input type="hidden" name="user_roles" value="5">
                                <input class="btn btn-submit btn-bold btn-block" type="submit" value="Register Now" name="user_register_btn">
                            </form>
                            <br>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="register-in-container">
                            <div class="intro">
                                <h4 class="box-title">Already Register?</h4>
